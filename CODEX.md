...
| `CODEX.md` | 1.13.16 | Active | N/A | Repository map, file inventory, page status, versions, and expertise mapping | Update for every file add, delete, rename, version change, page status change, or purpose change |
...
| `index.html` | 1.14.4 | Active | Beginner | Main static HTML entry point with same-tab cards linking to English education pages by expertise level plus completed Prompt Library pages, job-role audience cues on guide cards, a discreet French language-switch link, and bottom FAQ/disclaimer site notes; version is kept in machine-readable metadata and an HTML comment, not visible page text | Update whenever page library or locale paths change |
| `index_fr.html` | 1.1.4 | Active | Beginner | Canadian French static HTML entry point translated from `index.html`, with same-tab cards linking to expected French page paths, matching job-role audience cues, a discreet English language-switch link, and bottom FAQ/disclaimer site notes | Update whenever French page links, translated page availability, locale paths, or index structure change |
| `faq.html` | 1.0.2 | Active | Beginner | English site FAQ explaining what the AI Education Field Guide is, how the material was created, and how visitors should use it responsibly | Update when site-level FAQ guidance changes |
| `disclaimer.html` | 1.0.0 | Active | Beginner | English site disclaimer describing educational-use boundaries, professional review expectations, accuracy limits, external links, and responsibility for decisions | Update when site-level disclaimer guidance changes |
| `faq_fr.html` | 1.0.0 | Active | Beginner | Canadian French site FAQ explaining what the AI Education Field Guide is, how the material was created, and how visitors should use it responsibly | Update when French site-level FAQ guidance changes |
| `disclaimer_fr.html` | 1.0.0 | Active | Beginner | Canadian French site disclaimer describing educational-use boundaries, professional review expectations, accuracy limits, external links, and responsibility for decisions | Update when French site-level disclaimer guidance changes |
...
| File | Version | Status | Expertise | Purpose |
| --- | --- | --- | --- | --- |
| `pages/fr/beginner/ai-literacy-basics.html` | 1.0.3 | Active | Beginner | Canadian French translation of the AI literacy basics beginner guide |
| `pages/fr/beginner/ai-lexicon-for-beginners.html` | 1.0.4 | Active | Beginner | Canadian French translation of the AI lexicon for beginners guide |
| `pages/fr/beginner/ai-for-non-technical-people.html` | 1.0.4 | Active | Beginner | Canadian French translation of the AI for non-technical people beginner guide |
| `pages/fr/beginner/prompting-basics.html` | 1.0.4 | Active | Beginner | Canadian French translation of the prompting basics beginner guide |
| `pages/fr/beginner/privacy-and-safe-use.html` | 1.0.5 | Active | Beginner | Canadian French translation of the privacy and safe use beginner guide |
...
| `pages/fr/prompts/executive-summary-prompt.html` | 1.0.5 | Active | Beginner | Canadian French translation of the executive summary prompt library page |
| `pages/fr/prompts/document-review-prompt.html` | 1.0.5 | Active | Beginner | Canadian French translation of the document review prompt library page |
| `pages/fr/prompts/vibe-brief-prompt.html` | 1.0.4 | Active | Intermediate | Canadian French translation of the vibe brief prompt library page |
| `pages/fr/prompts/implementation-plan-prompt.html` | 1.0.5 | Active | Intermediate | Canadian French translation of the implementation plan prompt library page |
| `pages/fr/prompts/risk-review-prompt.html` | 1.0.5 | Active | Advanced | Canadian French translation of the risk review prompt library page |
| `pages/fr/prompts/checkpointed-execution-prompt.html` | 1.0.4 | Active | Intermediate | Canadian French translation of the checkpointed execution prompt library page |
| `pages/fr/prompts/code-review-prompt.html` | 1.0.4 | Active | Advanced | Canadian French translation of the code review prompt library page |
