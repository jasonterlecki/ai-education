...
| `CODEX.md` | 1.12.6 | Active | N/A | Repository map, file inventory, page status, versions, and expertise mapping | Update for every file add, delete, rename, version change, page status change, or purpose change |
...
| `PLAN_TRANSLATION.md` | 1.0.5 | Active | N/A | Controlled process and checklist for translating English AI Education pages into Canadian French one page at a time, including expected French-link targets before translated pages exist | Update when translation scope, translation rules, checklist status, or French locale workflow changes |
